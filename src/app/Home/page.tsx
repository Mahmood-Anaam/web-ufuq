...
const HomePage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary via-white to-secondary dark:from-bg-color-dark dark:via-gray-900 dark:to-gray-dark py-12 flex flex-col justify-between">
      {/* Header Section
      <header className="container mx-auto px-4 flex justify-between items-center mb-12">
        <h1 className="text-4xl font-extrabold text-accent">أفق</h1>
        <nav>
          <Link href="/signin" className="text-body-color dark:text-white mx-4">
            تسجيل الدخول
          </Link>
          <Link href="/signup" className="text-body-color dark:text-white mx-4">
            إنشاء حساب
          </Link>
          <Button className="bg-accent text-white py-2 px-4 rounded-full">المساعدة</Button>
        </nav>
      </header> */}
      ...
      >
        <h2 className="text-5xl font-bold text-gray-800 dark:text-white mb-4">رحلة تعليمية تفاعلية</h2>
      ...
      <section className="container mx-auto mt-16 grid gap-12 lg:grid-cols-3 md:grid-cols-2">
        ...
        >
          <h3 className="text-2xl font-bold text-accent mb-4">تفاعل مع الشخصيات الأدبية</h3>
          <p className="text-body-color dark:text-white">
            تحدث مع شعراء ومفكرين عرب عبر الزمن، تعلم منهم واستمتع برؤية العالم من خلال عيونهم.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-dark p-6 rounded-2xl shadow-lg"
        >
          <h3 className="text-2xl font-bold text-accent mb-4">التقدم عبر المستويات</h3>
          <p className="text-body-color dark:text-white">
            يخوض طفلك تجربة تعليمية متعددة المستويات، يبدأ من الأساسيات وصولًا إلى إتقان اللغة مع مرور الوقت.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-dark p-6 rounded-2xl shadow-lg"
        >
          <h3 className="text-2xl font-bold text-accent mb-4">اقتراحات تفاعلية</h3>
          <p className="text-body-color dark:text-white">
            يقدم التطبيق اقتراحات وأسئلة ذكية تساعد طفلك على استكشاف الموضوعات بطريقة شيقة، مما يعزز تجربته التعليمية.
          </p>
        </motion.div>
      </section>
